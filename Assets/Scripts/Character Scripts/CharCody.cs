...
public class CharCody : Character, IClick
{
    ...
    public override void LoadDialogue()
    {
        ...
        sequence1.Add("…….");
        sequence1.Add("…….");
        sequence1.Add("Well, nice talking to you. Bye-bye.");
        sequence1.Add("grunt");
        ...
        sequence2.Add("Trying to find any weaknesses I have?");
        ...
        sequence2_2.Add("YES!");
        sequence2_2.Add(".......");
        sequence2_2.Add("Well…. as I said, my name is Cody.");
        ...
        sequence3.Add("You don’t say…"); //italics
        ...
        sequence3.Add("Great, now I have to worry about getting killed outside of the game."); //Italics
        ...
        sequence3.Add("I don’t know anything about cars, but we are making some more progress here."); //italics
        sequence3.Add("What's your favorite part about fixing cars then?");
        sequence3.Add("Upgrading. I take an old car and add newer parts. I just got this Turbocharged 2.5-Liter-Inline-Five that I am trying to make fit into a classic Audi.");
        sequence3.Add("It might be impossible, but I like the challenge.");
        sequence3.Add("That's awesome! I like the look classic cars have. I feel like cars nowadays don't have the same personality. ");
        sequence3.Add("Exactly! Every car nowadays looks the same with no diversity.");
        sequence3.Add("You get it, huh. If we met under different circumstances, maybe I could have taken you for a ride.");
        ...
        sequence4.Add("I was a runaway. I left the orphanage I was at when I was around 12 years old.");
        sequence4.Add("It was a cold night and after I couldn’t run anymore, I found a foam mat in an alley to sleep on.");
        sequence4.Add("Right when I was about to close my eyes, a door opened in the alley and I was pulled inside.");
        sequence4.Add("I thought I was done for. I should have known better. Running away at 12? I barely knew how to make cereal!");
        sequence4.Add("When I came to my senses, two giant figures stood over me. It felt like they were each eight feet tall.");
        sequence4.Add("Then the lights turned on and it was two men. They looked like professional bodybuilders.");
        sequence4.Add("They just stood there, staring at me. They started asking me a bunch of questions.");
        sequence4.Add("“Who are you? Where are your parents? What are you doing in our alley?” I told them I ran away.");
        sequence4.Add("Then, they asked me why. I honestly didn’t have a good answer.");
        sequence4.Add("I was well taken care of at the orphanage. Got to eat 3 meals a day, and had a roof over my head.");
        ...
        sequence4.Add("Despite not having a real answer to give them, they understood me. It was almost like they were in a similar situation before.");
        sequence4.Add("From there, they pretty much raised me.");
        ...
        sequence4.Add("I just want them back. I don’t care about anything else... ");
        sequence4.Add("I knew there was nothing I could do to bring them back, but how can I just move on from something like that? ");
        ...
        sequence4.Add("It’s a shame it had to be like this though. I am sure everyone else here is a good person in a similar situation as me.");
    ...
    private void play3(){
        ...
        switch(curLine){
            ...
            case 3:
                ...
                break;
            case 4:
                SpriteChange(sBrowsFurrowed_ArmsCrossed);
                SwitchName(curName);
                break;
            case 5:
                SwitchStyle(FontStyle.Italic);
            ...
            case 8:
                ...
                break;
            case 9:
                SpriteChange(sBrowsFurrowed_KnucklesCrack);
                SwitchName(curName);
                break;
            case 10:
                SwitchName("You");
            ...
            case 21:
                ...
                break;
            case 22:
                SpriteChange(sNeutral_KnucklesCrack);
                SwitchName(curName);
                break;
            case 23:
                break;
